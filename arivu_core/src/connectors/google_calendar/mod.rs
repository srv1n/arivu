...
impl Connector for GoogleCalendarConnector {
    ...
    async fn list_tools(
        ...
        let mut tools = vec![
Tool { name: Cow::Borrowed("list_events"), title: None, description: Some(Cow::Borrowed("List upcoming events from primary calendar.")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"max_results":{"type":"integer","minimum":1,"maximum":250},"time_min":{"type":"string","description":"RFC3339"},"response_format":{"type":"string","enum":["concise","detailed"],"description":"Default concise."}},"required":[]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None },
        ];
        tools.push(Tool { name: std::borrow::Cow::Borrowed("create_event"), title: None, description: Some(std::borrow::Cow::Borrowed("Create an event in primary calendar.")), input_schema: std::sync::Arc::new(serde_json::json!({"type":"object","properties":{"summary":{"type":"string"},"start":{"type":"string","description":"RFC3339"},"end":{"type":"string","description":"RFC3339"}},"required":["summary","start","end"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: std::borrow::Cow::Borrowed("sync_events"), title: None, description: Some(std::borrow::Cow::Borrowed("Incremental sync using syncToken (returns nextSyncToken).")), input_schema: std::sync::Arc::new(serde_json::json!({"type":"object","properties":{"sync_token":{"type":"string"},"max_results":{"type":"integer","minimum":1,"maximum":250}} ,"required":["sync_token"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: std::borrow::Cow::Borrowed("update_event"), title: None, description: Some(std::borrow::Cow::Borrowed("Update an event in primary calendar (partial patch).")), input_schema: std::sync::Arc::new(serde_json::json!({"type":"object","properties":{"event_id":{"type":"string"},"summary":{"type":"string"},"start":{"type":"string","description":"RFC3339"},"end":{"type":"string","description":"RFC3339"}},"required":["event_id"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool {
            name: std::borrow::Cow::Borrowed("delete_event"),
            title: None,
            description: Some(std::borrow::Cow::Borrowed(
                "Delete an event in primary calendar by ID.",
            )),
        ...
        tools.push(Tool { name: std::borrow::Cow::Borrowed("watch_events"), title: None, description: Some(std::borrow::Cow::Borrowed("Start a webhook channel for calendar events (primary).")), input_schema: std::sync::Arc::new(serde_json::json!({"type":"object","properties":{"address":{"type":"string"},"id":{"type":"string"},"token":{"type":"string"}},"required":["address"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: std::borrow::Cow::Borrowed("stop_channel"), title: None, description: Some(std::borrow::Cow::Borrowed("Stop a previously created webhook channel (Drive/Calendar).")), input_schema: std::sync::Arc::new(serde_json::json!({"type":"object","properties":{"id":{"type":"string"},"resource_id":{"type":"string"}},"required":["id","resource_id"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
