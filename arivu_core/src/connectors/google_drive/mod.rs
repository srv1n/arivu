...
impl Connector for DriveConnector {
    ...
    async fn list_tools(
        ...
        tools.push(Tool { name: Cow::Borrowed("list_files"), title: None, description: Some(Cow::Borrowed("List files in Drive (name/id/mimeType).")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"q":{"type":"string","description":"Drive query string"},"page_size":{"type":"integer","minimum":1,"maximum":100},"response_format":{"type":"string","enum":["concise","detailed"],"description":"Default concise."}},"required":[]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: Cow::Borrowed("get_file"), title: None, description: Some(Cow::Borrowed("Get file metadata by ID.")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"file_id":{"type":"string"},"response_format":{"type":"string","enum":["concise","detailed"]}},"required":["file_id"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: Cow::Borrowed("download_file"), title: None, description: Some(Cow::Borrowed("Download file content by ID. Returns base64 data and mimeType.")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"file_id":{"type":"string"},"max_bytes":{"type":"integer","description":"Optional cap to avoid huge responses"}},"required":["file_id"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: Cow::Borrowed("export_file"), title: None, description: Some(Cow::Borrowed("Export Google Docs/Sheets/Slides to target MIME (e.g., application/pdf, text/csv). Returns base64 data.")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"file_id":{"type":"string"},"mime_type":{"type":"string","description":"Target MIME type"}},"required":["file_id","mime_type"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: Cow::Borrowed("upload_file"), title: None, description: Some(Cow::Borrowed("Upload a small file via base64 (multipart).")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"name":{"type":"string"},"mime_type":{"type":"string"},"data_base64":{"type":"string"},"parents":{"type":"array","items":{"type":"string"}}},"required":["name","mime_type","data_base64"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        tools.push(Tool { name: Cow::Borrowed("upload_file_resumable"), title: None, description: Some(Cow::Borrowed("Resumable upload via temp file (memory-friendly).")), input_schema: Arc::new(serde_json::json!({"type":"object","properties":{"name":{"type":"string"},"mime_type":{"type":"string"},"data_base64":{"type":"string"},"parents":{"type":"array","items":{"type":"string"}}},"required":["name","mime_type","data_base64"]}).as_object().expect("Schema object").clone()), output_schema: None, annotations: None, icons: None });
        // Auth helpers
